...
import { createUserController, readUserController, readUserListController } from "../controllers/user.controller";
...
userRoutes.get("/:id/courses", verifyToken, verifyPermission, readUserListController);